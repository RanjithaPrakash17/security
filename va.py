...
vat=Vatsyayana_cipher(text, CIPHER_DICT)
print("ecrypted messege",vat)


def DecryptionVatsyayana(vat, CIPHER_DICT):
...
print("Decrypted messege",DecryptionVatsyayana(vat, CIPHER_DICT))